...
from DNIHashGenerator import DNIHashGenerator
...
class DNIeHashGenerator(DNIHashGenerator):
    def __init__(self,
        ...
        DNIHashGenerator.__init__(self,
                                  ...
                                  birth_date_string,
                                  expiration_date_string)
        self.serial_number = serial_number_string.upper()
        self.__serial_number_hash = str(self.hash_string(self.serial_number))
        self.__final_hash = str(self.hash_string(self.serial_number +
    ...
    def serial_number_hash(self):
        return self.__serial_number_hash
