...
from DNICodeGenerator import DNICodeGenerator
from DNIeHashGenerator import DNIeHashGenerator


class DNIeCodeGenerator(DNICodeGenerator, DNIeHashGenerator):
    def __init__(self,
        ...
        self.serial_number = serial_number_string
